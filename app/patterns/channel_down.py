...
Production implementation of the Channel Down pattern.
"""
...
class ChannelDown(BaseSwingPattern):
    """
    Descending Price Channel detector.
    """

    name = "CHANNEL_DOWN"

    description = (
        "Bearish price channel formed by lower highs "
        "and lower lows moving in parallel."
    )
